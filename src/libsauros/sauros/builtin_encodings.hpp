...
constexpr uint8_t BUILTIN_ENTRY_COUNT = 66;
...
constexpr uint8_t BUILTIN_AS_LIST = 61;
constexpr uint8_t BUILTIN_ASYNC = 62;
constexpr uint8_t BUILTIN_CHAN = 63;
constexpr uint8_t BUILTIN_THREAD = 64;
constexpr uint8_t BUILTIN_REF = 65;
